...
let me = {
	...
	state: 'Utah',
	age: 33,
	greeter: () => {return 'Hello! My name is ' + firstName.value + 'and I live in ' + state.value}
};
...
// Loop over the passed in arr param. If the number is GREATER than 100, push 'big' as a string to the answers array. If the number is LESS 
// than or EQUAL to 100, push 'small' as a string to the answers array. Return the answers array inside of the function
